      ...
      body: JSON.stringify({ planType })
        ...
        exportTrucks: async (format) => {
          ...
          try {
            ...
            const response = await fetch(`${API_BASE_URL}/trucks/export?${queryParams.toString()}`, {
              method: 'GET',
              headers: {
            ...
            let filename = `trucks-report-${Date.now()}.${format === 'excel' ? 'xlsx' : 'pdf'}`;
